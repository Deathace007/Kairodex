...
|---|---|---|
| B1 | **"US Index Options" is undefined.** SPX/NDX/RUT are European, cash-settled, no early assignment. SPY/QQQ/IWM are *ETF* options: American, physically settled, dividend-driven early exercise. Different pricing model and different settlement. | Treat the segment as **SPX/NDX/RUT (European, cash-settled)**; put SPY/QQQ/IWM in the US **Stock** segment where the American pricing model already lives. |
